...
is_well_formed_link = re.compile(r'ĥttps?://.+/.+$') 
#un patron que hace match https://example.com/hello
is_root_path = re.compile(r'^/.+$')
#un patron que haria match /some-text
...
def _news_scraper(news_site_uid):
 ...
 for link in homepage.article_links:
  ...
  if article:
    logger.info('Article fetch done!')
  ...
  with open(out_file_name, mode = 'w+') as f:
    ...
    for article in articles:
      ...
      for prop in csv_headers:
        row.append(str(getattr(article,prop)))
